...
pub fn render_dashboard(frame: &mut Frame<'_>, area: Rect, snap: &MetricsSnapshot) {
    let block = Block::default()
        .title(Line::from(vec![
            Span::styled(" Rill Pipeline ", Style::default().fg(Color::Cyan).add_modifier(Modifier::BOLD)),
            Span::raw("─── "),
    ...
    let status_line = Line::from(vec![
        ...
        Span::styled(format_uptime(snap.uptime), Style::default().fg(Color::White)),
    ]);
    ...
    let counts = Line::from(vec![
        ...
        Span::styled(fmt_num(snap.elements_total), Style::default().fg(Color::White)),
        Span::raw("      "),
        Span::styled("Batches  ", Style::default().fg(Color::DarkGray)),
        Span::styled(fmt_num(snap.batches_total), Style::default().fg(Color::White)),
    ]);
    ...
    let cache_row1 = Line::from(vec![
        ...
        Span::styled(format!("{:.0}%", snap.l1_hit_rate), Style::default().fg(Color::Green)),
        Span::raw("  "),
        Span::styled("L2 Hit ", Style::default().fg(Color::DarkGray)),
        Span::styled(format!("{:.0}%", snap.l2_hit_rate), Style::default().fg(Color::Yellow)),
        Span::raw("  "),
        Span::styled("L3 Hit ", Style::default().fg(Color::DarkGray)),
        Span::styled(format!("{:.0}%", snap.l3_hit_rate), Style::default().fg(Color::Red)),
    ]);
    ...
    let latency_row1 = Line::from(vec![
        ...
        Span::styled(format!("{:.2}ms", snap.element_duration_p50 * 1000.0), Style::default().fg(Color::White)),
        Span::raw("  "),
        Span::styled("p99 ", Style::default().fg(Color::DarkGray)),
        Span::styled(format!("{:.2}ms", snap.element_duration_p99 * 1000.0), Style::default().fg(Color::White)),
    ]);
    ...
    let state_ops = Line::from(vec![
        ...
        Span::styled(format!("get={} put={}", fmt_num(snap.state_get_total), fmt_num(snap.state_put_total)), Style::default().fg(Color::White)),
    ]);
